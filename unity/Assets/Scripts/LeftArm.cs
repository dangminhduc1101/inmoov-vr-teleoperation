...
public class LeftArm : MonoBehaviour
{
    ...
    {
        float _pivotAngle = Vector3.SignedAngle(Vector3.forward, pos, Vector3.left);
        float _omoAngle = Mathf.Abs(Vector3.Angle(Vector3.left, pos) - 90);
    ...
    void Update()
    {
        ...
        {         
            ...
            _serial.SetArm(false, _pivot, _omo);
        } 
    }
}
